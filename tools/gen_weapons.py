...
WEAPONS = [
 ...
 w("flak_battery", FLK, 1, "플랙 포대", "Flak Battery", "피해는 낮지만 발사마다 요격 충전 +1.", "Light damage, but every shot grants an intercept charge.", 1, 1.6, 5.0, interceptCharge=1),
 w("flak_curtain", FLK, 2, "플랙 장막", "Flak Curtain", "발사마다 요격 충전 +1. 명중 +8%.", "Every shot grants an intercept charge; +8% accuracy.", 2, 2.6, 4.5, interceptCharge=1, accuracyBonus=0.08),
