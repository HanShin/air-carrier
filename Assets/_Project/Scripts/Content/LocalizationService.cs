...
namespace AetherArk.Content
{
    public sealed partial class LocalizationService
    {
        ...
        private void AddStrings()
        {
            ...
            Add("ui.storm_next", "다음 도약 후 봉쇄", "Closes after next jump");
            Add("ui.legend", "범례", "LEGEND");
            Add("ui.threat_battle", "제국 초계함과 교전이 예상됩니다.", "Expect an engagement with an Imperial patrol.");
            Add("ui.threat_elite", "정예 봉쇄선 — 강화된 순양함이 기다립니다.", "Elite blockade — a reinforced cruiser waits here.");
            Add("ui.threat_gate", "최종 관문. 강화된 함선과의 결전입니다.", "The final gate. A decisive battle against a reinforced ship.");
            Add("ui.threat_safe", "전투 없음. 이벤트가 진행됩니다.", "No battle. An event plays out here.");
            Add("ui.unaffordable", "에테르 부족", "Not enough aether");
            Add("ui.visited", "방문함", "Visited");
            Add("ui.accuracy_mod", "명중 {0}", "Accuracy {0}");
            Add("ui.ward_mod", "결계 재생 ×{0}", "Ward regen ×{0}");
