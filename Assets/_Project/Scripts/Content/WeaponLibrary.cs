...
namespace AetherArk.Content
{
    ...
    public static class WeaponLibrary
    {
        public static void AddAll(Dictionary<string, WeaponDefinition> result)
        {
            ...
            result["flak_battery"] = new WeaponDefinition { id = "flak_battery", nameKey = "weapon.flak_battery", descriptionKey = "weapon.flak_battery.desc", family = WeaponFamily.Flak, tier = 1, cost = 10, powerCost = 1, damage = 1.6f, cooldown = 3.0f, interceptCharge = 1 };
            result["flak_curtain"] = new WeaponDefinition { id = "flak_curtain", nameKey = "weapon.flak_curtain", descriptionKey = "weapon.flak_curtain.desc", family = WeaponFamily.Flak, tier = 2, cost = 18, powerCost = 2, damage = 2.6f, cooldown = 2.8f, interceptCharge = 1, accuracyBonus = 0.08f };
